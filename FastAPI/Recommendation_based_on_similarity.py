...
#
#
# def pipeline(data,input_str):
#     if list(data[0].keys()) == ['job_posting', 'jobPost_description']:
#         description_list = [
#             {"id": item.get("job_posting", ), "text": item.get("jobPost_description", "")}
#             for idx, item in enumerate(data)
#         ]
#     elif list(data[0].keys()) == ['resume_id', 'resume_description']:
#         description_list = [
...
#
#     top_json_results = [
#         {"id": item["id"], "similarity": f'{round(item["similarity"], 4)*100}점'}
